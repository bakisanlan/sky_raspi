...
def new_obj_NED_rel_home(euler_ang,obj_px_pos,camera_pos,home_alt):
    ...
    X = (15) * (R[0][0]* x + R[1][0] * y - f * R[2][0]) / (R[0][2]* x + R[1][2] * y - f * R[2][2]) + camera_pos[0]
    Y = (15) * (R[0][1]* x + R[1][1] * y - f * R[2][1]) / (R[0][2]* x + R[1][2] * y - f * R[2][2]) + camera_pos[1]

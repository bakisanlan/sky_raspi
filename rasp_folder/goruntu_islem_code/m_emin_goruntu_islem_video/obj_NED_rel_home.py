...
def obj_NED_rel_home(euler_ang,obj_px_pos,camera_pos_ned_rel_home):
    ...
    X = (6) * (R[0][0]* x + R[1][0] * y - f * R[2][0]) / (R[0][2]* x + R[1][2] * y - f * R[2][2]) + camera_pos_ned_rel_home[0]
    Y = (6) * (R[0][1]* x + R[1][1] * y - f * R[2][1]) / (R[0][2]* x + R[1][2] * y - f * R[2][2]) + camera_pos_ned_rel_home[1]

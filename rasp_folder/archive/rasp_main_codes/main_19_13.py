...
def print_obj_loc(detected_obj_px):
    if detected_obj_px != None:
        ...
        obj_ned_rel_home = obj_NED_rel_home([math.degrees(vehicle.attitude.roll),math.degrees(vehicle.attitude.pitch),math.degrees(vehicle.attitude.yaw)],detected_obj_px,list(vehicle_ned_rel_home),home_location.alt)

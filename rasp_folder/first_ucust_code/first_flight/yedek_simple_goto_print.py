...
if home_location== None:
    ...
    home_location = LocationGlobal(40.2320389,29.0083265,102)
            ...
            if detected_obj_px != None:
                ...
                if True:
                    ...
                    while True: #4
                        ...
                        if dist_vehicle_obj > 30:

                            print('Atese 100 metreden uzak oldu')
                            ...
                            while True: #3
                                ...
                                if detected_obj_px != None:
                                    ...
                                    print('En yakin wp: '.format(closest_cmd_next))
                                    ...
                                    while (time.time() - time_start) < 2:  #!
                                        ...
                                        if detected_obj_px != None:   
                                            ...
                                            while True: #2
                                                ...
                                                print(dist_vehicle_obj)

                                                print_now()

                                                if dist_vehicle_obj > 10:

                                                    print('Aradaki mesafe 100 metreyi gecti, atese gidiyor')
                                                    ...
                                                    while True: #1
                                                        ...
                                                        print('bearing: {} and dist_from_drop_p: {} '.format(bearing_to_wp,dist_from_drop_point))
